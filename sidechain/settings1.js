(function(exports){
    exports.rpcUrl = "http://path/to/sidechain-1/chain";
    // exports.rpcUrl = "http://localhost:12341/chain";
    exports.explorerUrl = "https://explorer.sidechain-1";
    exports.contractAddress = "ELF_T3oJonaDjRGKsxKqFa1Jqdpjp989noxjYeioNgFjW68pcFVQn"; // Update after deploying contract
    exports.accounts = [
        {
